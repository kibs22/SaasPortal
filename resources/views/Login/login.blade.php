        ...
        <div class="wrapper">
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a  class="navbar-brand brand" >  <img src="images/logo.png">  </a>
                </div>
       ...
       <div class="col-md-6 col-md-offset-3">
            <div class="card card0 border-0">
                    ...
                    <div class="row d-flex">
                        ...
                        <div class="col-lg-6">
                            <div class="card2 card border-0 px-4 py-5">
                                ...
                                <div class="row mb-4 px-3"> <small class="font-weight-bold">Don't have an account? <a  href="{{ route('register.index') }}" class="text-danger ">Register</a></small> </div>
                            </div>
                        </div>
                    </div>
                </form>
                <div class="bg-blue py-4">
                    <div class="row px-3"> 
                        <div class="social-contact ml-4 ml-sm-auto" style="padding-top:10px;">
